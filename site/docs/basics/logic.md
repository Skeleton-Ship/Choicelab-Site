...
As covered in the [previous chapter](/basics), you can add a _branch_ to your project flowchart to create paths, which are attached to one or more branch _stems_.
...
But how do you make a button the player presses _set_ a variable?
